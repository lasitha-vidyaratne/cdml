...
class MyMetaLearner(MetaLearner):
    ...
    def __init__(self, 
        ...
        self.model = Wrapper(rn_timm_mix(pretrained=False, name='seresnextaa101d_32x8d', #'swsl_resnet50', 
            momentum=0.1)).to(DEVICE) # no ImageNet pretraining
        ...
        while self.timer.time_left() > 60 * 5:
            ...
            for _ in range(5):
                ...
                for i, batch in enumerate(meta_train_generator(10)):
                    ...
                    # X_train = augment(X_train)  # no augmentation
